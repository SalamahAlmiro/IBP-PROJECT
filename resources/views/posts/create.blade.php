    ...
    <div class="max-w-2xl mx-auto p-4 bg-slate-200 dark:bg-slate-900 rounded-lg">
        ...
        <form method="POST" action="{{ route('posts.store') }}">
            ...
            <div class="mb-6">
                ...
                <input type="text" id="default-input" placeholder="Title" name="title" class="
                @error('title')
                    border-red-500
                    dark:border-red-500 
            ...
            <div class="mb-6">               
                ...
                <textarea id="message" rows="4" name="content" class="
                @error('content') 
                    border-red-500
                    dark:border-red-500 
                @enderror block p-2.5 w-full text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"></textarea>
                @error('content')
                    <span class="text-red-500 text sm">{{ $message }}</span>
                @enderror
            </div>
