<x-layout>
    ...
    <div class="max-w-6xl mx-auto sm:px-6 lg:px-7 mt-8 bg-slate-50 dark:bg-slate-700 rounded-lg">
        <h1 class="text-3xl font-bold text-center text-indigo-800 dark:text-indigo-400 font-semibold">{{ $post->title }}</h1>
